					...
					<div class="row">
						...
						<div class="col-md-10 text-right menu-1">
							<ul>
								...
								<li class="has-dropdown {{ $segment1 == 'guru' || $segment1 == 'siswa' ? 'active' : '' }}">
									<a href="">GTK Dan Siswa</a>
									<ul class="dropdown">
										<li class="{{ $segment1 == 'guru' ? 'active' : '' }}"><a href="{{ route('guru') }}">Data Guru</a></li>
										<li class="{{ $segment1 == 'siswa' ? 'active' : '' }}"><a href="{{  route('siswa') }}">Data Siswa</a></li>
										
									</ul>
								</li>
								<li class="{{ $segment1 == 'profil-alumni' ? 'active' : '' }}">
									<a href="{{ route('profil-alumni.index') }} ">Alumni</a>
								</li>
								<li class="has-dropdown {{ $segment1 == 'sarpras' || $segment2 == 'foto' || $segment2 == 'video' ? 'active' : '' }}">
									<a href="">Sarpras</a>
									<ul class="dropdown">
										<li class="{{ $segment1 == 'sarpras' ? 'active' : '' }}"><a href="{{ route('sarpras.index') }}">Sarpras</a></li>
										<li class="{{ $segment2 == 'foto' ? 'active' : '' }}"><a href="{{  route('gallery.index') }}">Gallery Foto</a></li>
										<li class="{{ $segment2 == 'video' ? 'active' : '' }}"><a href="{{  route('gallery.video.index') }}">Gallery Video</a></li>
										
									</ul>
								</li>
								
								<li class="{{ $segment1 == 'news' ? 'active' : '' }}"><a href="{{ route('news.index') }}">Pengumuman</a></li>
