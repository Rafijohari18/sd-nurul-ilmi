...
Route::middleware(['auth:sanctum', 'verified'])->get('/dashboard', function () {
    ...
    Route::get('/sarpras', 'App\Http\Controllers\Frontend\InformasiController@sarpras')->name('sarpras.index');
    Route::get('/gallery/foto', 'App\Http\Controllers\Frontend\InformasiController@gallery')->name('gallery.index');
    Route::get('/gallery/video', 'App\Http\Controllers\Frontend\InformasiController@galleryvideo')->name('gallery.video.index');

    Route::get('/guru', 'App\Http\Controllers\Frontend\InformasiController@guru')->name('guru');
    Route::get('/siswa', 'App\Http\Controllers\Frontend\InformasiController@siswa')->name('siswa');
